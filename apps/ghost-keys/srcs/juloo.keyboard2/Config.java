...
public final class Config
{
  ...
  public void refresh(Resources res, Boolean foldableUnfolded)
  {
    ...
    show_macro_row = _prefs.getBoolean("show_macro_row", true);
  ...
  private int getThemeId(Resources res, String theme_name)
  {
    ...
    switch (theme_name)
    {
      ...
      case "pkn": return R.style.PKN;
      case "pknred": return R.style.PKNRed;
      case "pknpurple": return R.style.PKNPurple;
      case "pknblue": return R.style.PKNBlue;
      case "pkngreen": return R.style.PKNGreen;
      case "pknyellow": return R.style.PKNYellow;
      default:
      case "system":
        if ((night_mode & Configuration.UI_MODE_NIGHT_NO) != 0)
