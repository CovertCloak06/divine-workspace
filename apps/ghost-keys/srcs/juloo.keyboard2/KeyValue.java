...
public final class KeyValue implements Comparable<KeyValue>
{
  ...
  public static KeyValue getSpecialKeyByName(String name)
  {
    switch (name)
    {
      ...
      case "macro_next": return eventKey("▶", Event.SWITCH_MACRO_NEXT, FLAG_SMALLER_FONT);
      case "macro_prev": return eventKey("◀", Event.SWITCH_MACRO_PREV, FLAG_SMALLER_FONT);
      case "macro_drawer": return eventKey("☰", Event.OPEN_MACRO_DRAWER, FLAG_SMALLER_FONT);
      case "save_macro": return eventKey("+", Event.SAVE_MACRO, FLAG_SMALLER_FONT);
