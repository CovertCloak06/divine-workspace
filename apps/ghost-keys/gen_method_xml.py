...
LOCALES = [
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_az",
        extra_keys="accent_trema:ü:ö@w|accent_cedille:ç:ş@s|ğ@g|ı@k|ə@l",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_azerty_be",
        extra_keys="accent_grave:è@f|accent_aigu:á:é:í:ó:ú:ý:j́@d|accent_circonflexe:ê@f|accent_cedille:ç@c|accent_trema@u|€",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_es",
        extra_keys="accent_aigu:á:é:í:ó:ú@d|accent_tilde:ñ@n|accent_grave@f|accent_trema@u|€",
    ),
    loc(
        "et_EE",
        "latin",
        "latn_qwerty_et",
        extra_keys="accent_trema:ä:ö:ü@u|accent_tilde:õ@o|accent_caron:š:ž@s|€",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_azerty_be",
        extra_keys="accent_grave:à:è:ù@f|accent_aigu:é@d|accent_circonflexe:ê:û@f|accent_cedille:ç@c|accent_trema@u|€",
    ),
    loc(
        "fr_CA",
        "latin",
        "latn_azerty_fr",
        extra_keys="accent_grave:à:è:ù@f|accent_aigu:é@d|accent_circonflexe:â:ê:ô:û@f|accent_cedille:ç@c|accent_trema:ë:ï:ü:ÿ@u",
    ),
    loc(
        "fr_CH",
        "latin",
        "latn_qwertz_fr_ch",
        extra_keys="accent_grave:à:è:ù@f|accent_aigu:é@d|accent_circonflexe:â:ê:ô:û@o|accent_cedille:ç@c|accent_trema:ë:ï:ü:ÿ@u|€",
    ),
    loc(
        "fr_FR",
        "latin",
        "latn_azerty_fr",
        extra_keys="accent_grave:à:è:ù@d|accent_aigu:é@d|accent_circonflexe:â:ê:ô:û@o|accent_cedille:ç@c|accent_trema:ë:ï:ü@l|€",
    ),
    loc(
        "ga_IE",
        "latin",
        "latn_qwerty_ga",
        extra_keys="accent_aigu:á:é:í:ó:ú@k|accent_dot_above@l",
    ),
    loc("ha_NG", "latin", "latn_qwerty_us", extra_keys="₦|ɓ|ɗ|ƙ|’|ƴ|r̃"),
    loc(
        "haw_US", "latin", "latn_qwerty_haw", extra_keys="ʻ@l|accent_macron:ā:ē:ī:ō:ū@m"
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwertz_hu",
        extra_keys="accent_aigu:á:é:í:ó:ú@d|accent_trema:ö:ü@u|accent_ogonek@s|accent_double_aigu:ő:ű@k|€",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_is",
        extra_keys="ð|þ|æ|accent_trema:ö@o|accent_aigu:á:é:í:ó:ú:ý@d|accent_circonflexe|accent_ring|accent_grave",
    ),
    loc(
        "it_IT",
        "latin",
        "latn_qwerty_us",
        extra_keys="accent_grave:à:è:ì:ò:ù@f|accent_aigu:é:ó@d|accent_circonflexe:î@f|€|ə",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_lt",
        extra_keys="accent_ogonek:ą:ę:į:ų@s|accent_caron:č:š:ž@f|accent_dot_above:ė@s|accent_macron:ū@o|€",
    ),
    loc(
        "lv_LV",
        "latin",
        "latn_qwerty_lv",
        extra_keys="accent_macron:ā:ē:ī:ū@o|accent_caron:č:š:ž@f|accent_ogonek:ķ:ļ:ņ@s|accent_cedille:ģ@c|€",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_mt",
        extra_keys="accent_grave:à:è:ì:ò:ù|accent_dot_above:ċ:ż:ġ|ħ",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_us",
        extra_keys="€|æ@a|å@a|ø@o|accent_aigu:é:ó@d|accent_grave:è:ò:ù@f|accent_circonflexe:ê:ô@f",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_pt",
        extra_keys="accent_aigu:á:é:í:ó:ú@d|accent_cedille:ç@c|accent_circonflexe:â:ê:ô@f|accent_grave:à:ò@f|accent_tilde:ã:õ@n|€|ª|º",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwertz_sk",
        extra_keys="accent_caron:ě:ř:ž:š:č:ň:ď:ľ:ť@f|accent_ring:ů@s|accent_circonflexe:ô@f|accent_trema:ä:ü:ö@u|accent_aigu:á:é:í:ó:ú:ŕ:ś:ĺ:ý@d",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_se",
        extra_keys="accent_aigu:á@d|accent_trema:ä:ö@o|accent_ring:å@s|€",
    ),
    ...
    loc(
        ...
        "latin",
        "latn_qwerty_tr",
        extra_keys="accent_cedille:ç:ş@c|accent_trema:ö:ü@u|accent_circonflexe:â:î:û@f|₺|ı|ğ",
    ),
...
def compute_tags():
    ...
    locales_grouped = {
        k: list(v) for k, v in it.groupby(sorted(LOCALES, key=lang), lang)
    }
    ...
    def tag(loc):
        if "tag" in loc:
            return loc["tag"]
        l = lang(loc)
        if loc["name"] == f"{l}_{l.upper()}":
            return l  # Locales like "fr_FR"
