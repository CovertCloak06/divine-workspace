...
class ConversationMemory:
    ...
    def __init__(self, project_root: str = None):
        # Auto-detect project root: backend/memory/conversation_memory.py -> apps/pkn/
...
if __name__ == "__main__":
    ...
    conversation_memory.add_message(
        session_id, "user", "Write a function to calculate fibonacci numbers"
    )
    conversation_memory.add_message(
        session_id,
        "assistant",
    ...
    conversation_memory.add_message(session_id, "user", "Now add unit tests")
