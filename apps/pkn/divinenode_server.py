...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""",
        ...
        return jsonify({"error": str(e), "summary": f"Error: {str(e)}"}), 500
...
def write_file_content():
    ...
    try:
        ...
        return jsonify(
            {"success": True, "message": f"File saved: {file_path.name}"}
        ), 200
    except Exception as e:
...
def list_ollama_models():
    ...
    try:
        ...
        if not models:
            ...
            if last_err:
                return jsonify(
                    {"models": [], "error": f"Ollama query failed: {last_err}"}
                ), 502
